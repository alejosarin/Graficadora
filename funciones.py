...
color_bt ="LightBlue3"
def salir():
    messagebox.showinfo("la app se cerrara","La app se cerrará..")
...
def funcion_lineal():
  ...
  lb_x.config(bg=color, fg=letras, font=("Arial",16))
  ...
  lb_x = Label(frame_operaciones, text = "            ")
  lb_x.config(bg=color, fg=letras, font=("Arial",16))
  lb_x.place(x=180,y=150, width=100, height=30)

  lb_x = Label(frame_operaciones, text = "            ")
  lb_x.config(bg=color, fg=letras, font=("Arial",16))
  lb_x.place(x=350,y=150, width=100, height=30)
...
def funcion_cuadratica():
  ...
  entry_x.config(font=("Arial",20), justify=LEFT, fg=letras)
  entry_x.focus_set()
  entry_x.place(x=135,y=20,width=115, height=30)
  # etiqueta para b
  lb_x = Label(frame_operaciones, text = "b =  ")
...
lb_logo.place(x=10,y=70,width=180,height=182)
lb_logo.config(bg="black")
...
etiqueta = Label(textvariable=variable_control, width= len(texto), padx=100, pady=10, fg="purple3",bg="black", font=("Arial", "28", "bold"))
etiqueta.pack()
...
bt_expotencial.config(bg=color_bt)
...
bt_logaritmo.config(bg=color_bt)
...
bt_trigonometrica.config(bg=color_bt)

#funcion salir
bt_salir= Button(ventana_principal, text="Salir", command=salir)
bt_salir.place(x=320,y=235, width=100, height=30)
bt_salir.config(bg="red")

# ------------------------
# frame operaciones
# ------------------------
frame_operaciones = Frame(ventana_principal)
frame_operaciones.config(bg=color, width=480, height=190)
